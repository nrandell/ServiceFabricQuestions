        ...
        private static void Main()
        {
            try
            {
                ...
                using (FabricRuntime fabricRuntime = FabricRuntime.Create())
                {
                    ...
                    fabricRuntime.RegisterServiceType("QueuingService1Type", typeof(QueuingService1));

                    ServiceEventSource.Current.ServiceTypeRegistered(Process.GetCurrentProcess().Id, typeof(QueuingService1).Name);
