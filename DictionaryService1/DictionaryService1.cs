...
namespace DictionaryService1
{
    /// <summary>
    /// The FabricRuntime creates an instance of this class for each service type instance.
    /// </summary>
    internal sealed class DictionaryService1 : StatefulService
    {
        /// <summary>
        ...
        protected override async Task RunAsync(CancellationToken cancelServicePartitionReplica)
        {
            ...
            while (!cancelServicePartitionReplica.IsCancellationRequested)
            {
                ...
                using (var tx = this.StateManager.CreateTransaction())
                {
                    ...
                    ServiceEventSource.Current.ServiceMessage(this, "Current Counter Value: {0} {1} {2}",
                        ServiceInitializationParameters.ServiceName, ServiceInitializationParameters.PartitionId,
