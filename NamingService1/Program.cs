        ...
        private static void Main()
        {
            try
            {
                ...
                using (FabricRuntime fabricRuntime = FabricRuntime.Create())
                {
                    ...
                    fabricRuntime.RegisterServiceType("NamingService1Type", typeof(NamingService1));

                    ServiceEventSource.Current.ServiceTypeRegistered(Process.GetCurrentProcess().Id, typeof(NamingService1).Name);
